...
namespace Forms
{
    public partial class Form_principal : Form
    {
        ...
        private void tsm_CargarDatos_Click(object sender, EventArgs e)
        {
            ...
            listaProductos.Add(new Producto("Neumatico", "Yokohoma", 6000, 1000, 1, 130));
        ...
        private void comprarProductoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (form_nuevaCompra.DialogResult == DialogResult.OK)
            {
                ...
                MessageBox.Show("Gracias por su compra !! Vuelva Prontoss", "Exito", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
        }
        ...
        private void stockConMenosDe10UnidadesToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Form_StockMenorA10 datosProductos = new Form_StockMenorA10(this.listaProductos);
            datosProductos.ShowDialog();
        }
    }
}
